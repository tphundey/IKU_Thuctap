	...
	buildCheckoutUrl(payload) {
		return new Promise((resolve, reject) => {
			...
			if (secureCode.length > 0) {
				redirectUrl.searchParams.append('secure_hash', (0, _utils.toUpperCase)((0, _utils.hashHmac)('SHA256', secureCode.join('&'), (0, _utils.pack)(config.secureSecret))));
			}
	...
	verifyReturnUrl(query) {
		return new Promise(resolve => {
			...
			if (config.secureSecret.length > 0) {
				...
				const isEqual = (0, _utils.toUpperCase)(secureHash) === (0, _utils.toUpperCase)((0, _utils.hashHmac)('SHA256', secureCode.join('&'), (0, _utils.pack)(config.secureSecret)));
...
SohaPay.configSchema = new _simplSchema2.default({
 ...
 * @type {SimpleSchema}
 */
SohaPay.checkoutSchema = new _simplSchema2.default({
	language: { type: String, max: 16 },
	orderId: { type: String, max: 34 },
	customerEmail: { type: String, max: 24, regEx: _simplSchema2.default.RegEx.Email },
...
exports.SohaPay = SohaPay;
//# sourceMappingURL=SohaPay.js.map