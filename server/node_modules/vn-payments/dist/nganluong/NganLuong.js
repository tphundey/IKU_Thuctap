  ...
  */
	buildCheckoutUrl(payload) {
		return new Promise((resolve, reject) => {
			...
			(0, _nodeFetch2.default)(`${url}?${params.join('&')}`, options).then(rs => rs.text()).then(rs => {
				(0, _xml2js.parseString)(rs, (err, result) => {
...
NganLuong.checkoutSchema = new _simplSchema2.default({
	...
	amount: { type: _simplSchema2.default.Integer },
	...
	receiverEmail: { type: String, max: 255, regEx: _simplSchema2.default.RegEx.Email },
	...
	taxAmount: { type: _simplSchema2.default.Integer, optional: true },
	discountAmount: { type: _simplSchema2.default.Integer, optional: true },
	feeShipping: { type: _simplSchema2.default.Integer, optional: true },
	customerEmail: { type: String, max: 255, regEx: _simplSchema2.default.RegEx.Email },
	...
	timeLimit: { type: _simplSchema2.default.Integer, optional: true }, // minutes
...
//# sourceMappingURL=NganLuong.js.map