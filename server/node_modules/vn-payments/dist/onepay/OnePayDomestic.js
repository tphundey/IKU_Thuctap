...
exports.OnePayDomestic = undefined;
 ...
 * this.response.end();
 */
class OnePayDomestic extends _OnePay.OnePay {
	/**
  *
 ...
 * @author Thanh
 */
OnePayDomestic.checkoutSchema = new _simplSchema2.default({
	againLink: { type: String, optional: true, max: 64, regEx: _utils.urlRegExp },
...
exports.OnePayDomestic = OnePayDomestic;
//# sourceMappingURL=OnePayDomestic.js.map